...
public class SendEmail {
    ...
    // 发件人
    private String from = "vivinia@163.com";
    // 收件人
    private String to = "";
    // 初始化连接邮件服务器的会话信息
    ...
    public void sendTextEmail(long Num) throws Exception {
        ...
        // 打开连接
        transport.connect("vivinia", "weiweikeke520");
    ...
    static class MyAuthenticator extends Authenticator {
        ...
        private String username = "vivinia";

        private String password = "weiweikeke520";
