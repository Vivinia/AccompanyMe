...
import com.example.weixu.adpter.IntelligenceFragmentPagerAdapter;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link IntelligenceFragment.OnFragmentInteractionListener} interface
...
public class IntelligenceFragment extends Fragment {
    ...
    public static IntelligenceFragment newInstance(String param1, String param2) {
    ...
    private void initTabLayout(View view) {
        //ViewPager
        vpFindPager = (ViewPager) view.findViewById(R.id.vp_1);
        IntelligenceFragmentPagerAdapter adapter = new IntelligenceFragmentPagerAdapter(getChildFragmentManager());
        vpFindPager.setAdapter(adapter);
        //TabLayout
        tabLayout = (TabLayout) view.findViewById(R.id.tl_1);
